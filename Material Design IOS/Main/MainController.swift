...
class MainController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
   ...
   let BackGroundImage = [UIImage(named: "backone"), UIImage(named: "back2"), UIImage(named: "back3"), UIImage(named: "back4"), UIImage(named: "back5"), UIImage(named: "back6"), UIImage(named: "back7"), UIImage(named: "back8")]
    let sideimage = [UIImage(named: "Login"), UIImage(named: "Ecormence"), UIImage(named: "walk"), UIImage(named: "menu"), UIImage(named: "gallery"), UIImage(named: "online-shop"), UIImage(named: "Profile"), UIImage(named: "content")]
...
//      CGSize(width: self.view.frame.size.width/2.3, height: self.view.frame.size.height/5)
...
//        collMenu.backgroundView = imageBg
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.img.image = BackGroundImage[indexPath.row]
        cell.sideimge.image = sideimage[indexPath.row]
        return cell
    }

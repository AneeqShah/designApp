...
class ActivityStyle5Controller: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, ViewActivityStyle1HeaderDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            stringAttributed.addAttribute(NSAttributedStringKey.font, value:font!, range: NSRange.init(location: locDefault, length: stringDefault.characters.count))
            stringAttributed.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.init(red: 103/255.0, green: 147/255.0, blue: 211/255.0, alpha: 1.0), range: NSRange.init(location: locColor, length: stringColor.characters.count))
        ...
        case 4:
            ...
            stringAttributed.addAttribute(NSAttributedStringKey.font, value:font!, range: NSRange.init(location: locDefault, length: stringDefault.characters.count))
            stringAttributed.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.init(red: 255/255.0, green: 204/255.0, blue: 102/255.0, alpha: 1.0), range: NSRange.init(location: locColor, length: stringColor.characters.count))

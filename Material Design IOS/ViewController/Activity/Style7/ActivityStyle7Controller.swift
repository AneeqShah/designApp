...
class ActivityStyle7Controller: UIViewController, ViewActivityStyle1HeaderDelegate {
    ...
    func createView(){
        ...
        stringAttributed.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.white, range: NSRange.init(location: locColor, length: stringColor.characters.count))

...
class MenuControllerStyle16: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, MenuStyle1HeaderDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            stringAttributed.addAttribute(NSAttributedStringKey.font, value:font!, range: NSRange.init(location: 0, length: 0))
            stringAttributed.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.lightGray, range: NSRange.init(location: lengt-14, length: 14))
        ...
        case 1:
            ...
            let font = UIFont(name: "verdana-bold", size: 12.0)
            stringAttributed.addAttribute(NSAttributedStringKey.font, value:font!, range: NSRange.init(location: 0, length: 0))
            stringAttributed.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.lightGray, range: NSRange.init(location: lengt-15, length: 15))
            cell.name?.attributedText = stringAttributed
        ...
        case 2:
            ...
            let font = UIFont(name: "verdana-bold", size: 12.0)
            stringAttributed.addAttribute(NSAttributedStringKey.font, value:font!, range: NSRange.init(location: 0, length: 0))
            stringAttributed.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.lightGray, range: NSRange.init(location: lengt-19, length: 19))
            cell.name?.attributedText = stringAttributed
